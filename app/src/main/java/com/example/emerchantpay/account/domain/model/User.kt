...
data class User(
    ...
    @SerializedName(UserJsonKeys.ID) @ColumnInfo(name = UserRoomConstants.ID) val id: Long,
    @SerializedName(UserJsonKeys.NODE_ID) @ColumnInfo(name = UserRoomConstants.NODE_ID) val nodeId: String,
    @SerializedName(UserJsonKeys.AVATAR_URL) @ColumnInfo(name = UserRoomConstants.AVATAR_URL) val avatarUrl: String,
    @SerializedName(UserJsonKeys.GRAVATAR_ID) @ColumnInfo(name = UserRoomConstants.GRAVATAR_ID) val gravatarId: String,
    ...
    @SerializedName(UserJsonKeys.SITE_ADMIN) @ColumnInfo(name = UserRoomConstants.SITE_ADMIN) val siteAdmin: Boolean,
    ...
    @SerializedName(UserJsonKeys.HIREABLE) @ColumnInfo(name = UserRoomConstants.HIREABLE) val hireable: Boolean?,
    ...
    @SerializedName(UserJsonKeys.PUBLIC_REPOS) @ColumnInfo(name = UserRoomConstants.PUBLIC_REPOS) val publicRepos: Int,
    @SerializedName(UserJsonKeys.PUBLIC_GISTS) @ColumnInfo(name = UserRoomConstants.PUBLIC_GISTS) val publicGists: Int,
    @SerializedName(UserJsonKeys.FOLLOWERS) @ColumnInfo(name = UserRoomConstants.FOLLOWERS) val followers: Int,
    @SerializedName(UserJsonKeys.FOLLOWING) @ColumnInfo(name = UserRoomConstants.FOLLOWING) val following: Int,
